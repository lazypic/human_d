...
#### [인간향상의 생명정치적 지형](https://github.com/lazypic/human_d#%EC%9D%B8%EA%B0%84%ED%96%A5%EC%83%81%EC%9D%98-%EC%83%9D%EB%AA%85%EC%A0%95%EC%B9%98%EC%A0%81-%EC%A7%80%ED%98%95-1)

#### [비판 요소](https://github.com/lazypic/human_d#%EB%B9%84%ED%8C%90-%EC%9A%94%EC%86%8C-1)
...
### 구상중
  ...
  - Keyword
    ...
    - 디지털 휴먼 스캔
    - 트랜센던스
    - 제작된 데이터는 고유의 식별이 가능한 ID가 발급되어야 한다.
    - 식별 ID는 출신 국가의 기반이 아닌 거주지 위/경도 좌표 번호와 실명이 반영되어 만들어질 것
      - 37_5_127_0_sehwan_jo
      - 37_5_127_0_gildong_hong
    - 데이터의 영구 보존 관리가 가능한 공간이 필요
    - 데이터에 의뢰자의 접근 및 열람이 가능하여야 함
    - 데이터 열람시 여러 단계의 보안 필요
...
<img src="https://github.com/lazypic/human_d/blob/master/imgs/ieetChart.JPG?raw=true" width=100% >
